...
namespace ms_aula.Migrations
{
    ...
    [Migration("20250715213054_FavoritadoPosicaoMural")]
    partial class FavoritadoPosicaoMural
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ms_aula.Domains.AreaFisicaDivisao", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AreaFisicaDivisao");
                });

            modelBuilder.Entity("ms_aula.Domains.ArquivoPdf", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ms_aula.Domains.Aula", b =>
                {
                    ...
                    b.Property<long?>("AulaAnteriorId")
                        .HasColumnType("bigint");

                    b.Property<long?>("AulaPosteriorId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ms_aula.Domains.AulaSessaoFavoritada", b =>
                {
                    ...
                    b.Property<long>("MuralPosicaoX")
                        .HasColumnType("bigint");

                    b.Property<long>("MuralPosicaoY")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ms_aula.Domains.AulaTag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ms_aula.Domains.Tag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ms_aula.Domains.AulaTag", b =>
                {
                    b.HasOne("ms_aula.Domains.Aula", "Aula")
                        .WithMany("AulaTagMany")
                        .HasForeignKey("AulaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ms_aula.Domains.Tag", "Tag")
                        .WithMany("AulaTagMany")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
